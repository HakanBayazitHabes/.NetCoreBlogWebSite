...
namespace CoreDemo.Areas.Admin.Controllers
{
    ...
    public class AdminRolController : Controller
    {
        ...
        public async Task<IActionResult> AssignRole(int id)
        {
            ...
            List<RoleAssignViewModal> model = new List<RoleAssignViewModal>();
            foreach (var item in roles)
            {
                RoleAssignViewModal m = new RoleAssignViewModal();
                m.RoleID = item.Id;
                m.Name = item.Name;
        ...
        [HttpPost]
        public async Task<IActionResult> AssignRole(List<RoleAssignViewModal> modal)
        {
